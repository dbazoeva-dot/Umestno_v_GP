...
export interface SkuCatalogRow { sku_id: string; division_type: DivisionType; rigidity?: string; set_quantity?: number; width_cm?: number; depth_cm?: number; height_cm?: number; can_rotate?: string; capacity_units?: number; cell_width_cm?: number; cell_depth_cm?: number; color_group?: string; availability_status?: string; product_title?: string; product_url?: string; picture_matching?: string; seller_or_brand?: string; price?: number }
