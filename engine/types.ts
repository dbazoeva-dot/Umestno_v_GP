...
export interface SkuCatalogRow {
  sku_id: string; division_type: DivisionType; rigidity: string;
  width_cm: number; depth_cm: number; height_cm: number; capacity_units: number;
  // Matching
  color_group?: string; color_normalized?: string; material_group?: string;
  availability_status: string;
  // Display
  product_title: string; seller_or_brand?: string; source_platform?: string;
  product_url?: string; affiliate_url?: string; affiliate_status?: string;
  price_rub?: number; image_url?: string; image_reference?: string;
}
