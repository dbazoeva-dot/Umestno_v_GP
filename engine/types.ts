...
export interface SkuCatalogRow { sku_id: string; division_type: DivisionType; rigidity: string; width_cm: number; depth_cm: number; height_cm: number; capacity_units: number; color_group?: string; availability_status: string; product_title: string; product_url?: string; image_reference?: string }
