...
const Icon = ({ name, size = 20, stroke = 1.6 }) => {
  ...
  switch (name) {
    ...
    case 'shield':return <svg {...p} style={{ width: "40px", height: "40px" }}><path d="M12 3l8 3v6c0 5-3.5 8-8 9-4.5-1-8-4-8-9V6l8-3z" /><path d="M9 12l2 2 4-4" /></svg>;
    ...
    case 'bulb':return <svg {...p} style={{ width: "45px", height: "4px" }}><path d="M9 18h6M10 21h4" /><path d="M12 3a6 6 0 00-4 10c1 .8 1.5 1.6 1.5 3h5c0-1.4.5-2.2 1.5-3A6 6 0 0012 3z" /></svg>;
