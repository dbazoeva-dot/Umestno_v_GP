...
(function (global) {
  ...
  var WARNING_TEXT = {
    compressed_storage: 'Для категории {category} по высоте остаётся совсем мало места: вещи поместятся, но будут лежать плотно и могут слегка примяться. Пожалуйста, будьте внимательны при складывании.',
    deformation_risk:   'Для категории {category} по высоте остаётся совсем мало места: {category} поместятся, но чашки могут быть сжаты и потерять форму. Для жёстких моделей лучше выбрать более высокий ящик.'
  };
