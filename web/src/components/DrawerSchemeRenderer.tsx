    ...
    >
      ...
      {zoneRenders.map((z) => {
        ...
        return (
          ...
          >
            <rect
              x={z.px - (isHovered ? half : 0)}
              y={z.py - (isHovered ? half : 0)}
              width={z.pw + (isHovered ? ZONE_GAP : 0)}
              height={z.ph + (isHovered ? ZONE_GAP : 0)}
              fill={z.fillColor}
              stroke={isHovered ? BRAND.accent : z.strokeColor}
