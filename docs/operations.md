...
**Важно про VK Workspace:** админка (biz.mail.ru под `dzerissimo@gmail.com`) и рабочие ящики (info@, help@, partners@ на e.mail.ru) **конфликтуют по сессиям VK ID**. Если открыть админку в обычной вкладке, после этого нельзя войти в рабочие ящики — VK ID молча возвращает на «Выбор аккаунта» с админским gmail. Решение: **админку открывать в Инкогнито**, рабочие ящики — в обычном браузере. Так каждая сессия живёт отдельно и не блокирует другую.
